...
/**
 * The base implementation of the purchase item local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sb.service.impl.PurchaseItemLocalServiceImpl}.
 * </p>
 *
 * @author amifxw0
 * @see com.sb.service.impl.PurchaseItemLocalServiceImpl
 * @see com.sb.service.PurchaseItemLocalServiceUtil
 * @generated
 */
public abstract class PurchaseItemLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PurchaseItemLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sb.service.PurchaseItemLocalServiceUtil} to access the purchase item local service.
	 */
	...
	public PurchaseItem addPurchaseItem(PurchaseItem purchaseItem)
		...
		return purchaseItemPersistence.update(purchaseItem, false);
	}
	 ...
	 */
	public PurchaseItem createPurchaseItem(int PurchaseItemId) {
		return purchaseItemPersistence.create(PurchaseItemId);
	}
	...
	public PurchaseItem deletePurchaseItem(int PurchaseItemId)
		throws PortalException, SystemException {
		return purchaseItemPersistence.remove(PurchaseItemId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public PurchaseItem deletePurchaseItem(PurchaseItem purchaseItem)
		throws SystemException {
		return purchaseItemPersistence.remove(purchaseItem);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(PurchaseItem.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return purchaseItemPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return purchaseItemPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PurchaseItem fetchPurchaseItem(int PurchaseItemId)
		throws SystemException {
		return purchaseItemPersistence.fetchByPrimaryKey(PurchaseItemId);
	}
	...
	public PurchaseItem getPurchaseItem(int PurchaseItemId)
		throws PortalException, SystemException {
		return purchaseItemPersistence.findByPrimaryKey(PurchaseItemId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return purchaseItemPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PurchaseItem> getPurchaseItems(int start, int end)
		throws SystemException {
		return purchaseItemPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPurchaseItemsCount() throws SystemException {
		return purchaseItemPersistence.countAll();
	}
	...
	public PurchaseItem updatePurchaseItem(PurchaseItem purchaseItem)
		throws SystemException {
		return updatePurchaseItem(purchaseItem, true);
	}
	...
	public PurchaseItem updatePurchaseItem(PurchaseItem purchaseItem,
		...
		return purchaseItemPersistence.update(purchaseItem, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.sb.model.PurchaseItem",
			purchaseItemLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.sb.model.PurchaseItem");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = purchaseItemPersistence.getDataSource();
	...
	private PurchaseItemLocalServiceClpInvoker _clpInvoker = new PurchaseItemLocalServiceClpInvoker();
}