 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sb.service.impl.PurchaseOrderLocalServiceImpl}.
 * </p>
 *
 * @author amifxw0
...
public abstract class PurchaseOrderLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.sb.service.PurchaseOrderLocalServiceUtil} to access the purchase order local service.
	 */
	 ...
	 */
	public PurchaseOrder createPurchaseOrder(int PoId) {
		return purchaseOrderPersistence.create(PoId);
	}
	...
	public PurchaseOrder deletePurchaseOrder(int PoId)
		throws PortalException, SystemException {
		return purchaseOrderPersistence.remove(PoId);
	}
	...
	public PurchaseOrder fetchPurchaseOrder(int PoId) throws SystemException {
		return purchaseOrderPersistence.fetchByPrimaryKey(PoId);
	}
	...
	public PurchaseOrder getPurchaseOrder(int PoId)
		throws PortalException, SystemException {
		return purchaseOrderPersistence.findByPrimaryKey(PoId);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.sb.model.PurchaseOrder",
			purchaseOrderLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.sb.model.PurchaseOrder");
	}
