...
public class InventoryGrid {
	...
	public void actionMapping(ActionRequest request, ActionResponse response) throws SystemException {
		 ...
		 */
		if (loggedInUserID != null && request.getPortletSession().getAttribute("loggedInUserID") == null)
			request.getPortletSession().setAttribute("loggedInUserID", loggedInUserID);
		
		// Get all of items from DB
		List<Item> inventoryList = ItemLocalServiceUtil.getItems(0, ItemLocalServiceUtil.getItemsCount());
